...
$$
\mathrm{BF}_{01}=\frac{\int_{Z} p\left(\text { data } | \theta_{0}, \zeta, \mathcal{H}_{0}\right) p\left(\zeta | \theta_{0}, \mathcal{H}_{0}\right) \mathrm{d} \zeta}{\int_{\Theta} \int_{Z} p\left(\text { data } | \theta, \zeta, \mathcal{H}_{1}\right) p\left(\theta, \zeta | \mathcal{H}_{1}\right) \mathrm{d} \zeta \mathrm{d} \theta}
$$
